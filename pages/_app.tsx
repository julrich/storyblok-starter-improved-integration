...
const fontOnePreload = localFont({
  src: [
...
const fontOne = localFont({
  src: [
    ...
    { path: "/fonts/Fredoka-SemiBold.woff2", weight: "600", style: "normal" },
    { path: "/fonts/Fredoka-SemiBold.woff", weight: "600", style: "normal" },
...
const fontTwoPreload = localFont({
  src: [
